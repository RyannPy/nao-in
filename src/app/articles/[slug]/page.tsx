...
export default async function ArticleSlugPage({ params }: Props) {
  ...
  return (
    <PageContainer innerClassName="px-6 md:px-10 py-10 max-w-3xl mx-auto">
      ...
      {/* ════════════════════════════════════════════
          5. HERO IMAGE (conditional)
      ════════════════════════════════════════════ */}
      {article.image_src && (
        <div className="relative w-full mb-10 border border-[#b8b8b8]">
          {/* Corner ticks — industrial frame */}
          <span className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#e8c830] z-10" />
          <span className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#e8c830] z-10" />
          <span className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#e8c830] z-10" />
          <span className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#e8c830] z-10" />

          {/* ID badge overlay */}
          <div className="absolute top-0 left-4 z-10 flex items-center gap-2 bg-[#1a1a1a] px-2.5 py-1">
            <span className="w-1 h-1 bg-[#e8c830]" />
            <span
      ...
      <div className="relative border-l-[3px] border-[#e8c830] pl-5 mb-10">
        ...
        <p className="text-[13px] leading-[1.8] text-[#555] italic">
          {article.excerpt}
        </p>
      </div>

      {/* ════════════════════════════════════════════
          7. MAIN ARTICLE CONTENT
      ════════════════════════════════════════════ */}
      ...
      {/* ════════════════════════════════════════════
          8B. BACK BUTTON + FOOTER METADATA
      ════════════════════════════════════════════ */}
