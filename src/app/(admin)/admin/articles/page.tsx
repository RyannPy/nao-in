...
const MOCK_ARTICLES: Article[] = [
  ...
  {
    id: "ART-004",
    title: "The Fermi Paradox — Updated with 2026 Data",
    slug: "fermi-paradox-2026",
    category: "science",
    excerpt: "New telescope data changes some of the old assumptions about the great filter.",
    image_src: "",
    date: "2026-04-30",
    featured: true,
    publish_status: "published",
  ...
  {
    id: "ART-005",
    title: "Quiet City — A Short Story",
    slug: "quiet-city-short-story",
    category: "story",
    excerpt: "She found the last working radio tower in the city and wasn't sure what to broadcast.",
    image_src: "",
    date: "2026-04-22",
    featured: false,
    publish_status: "draft",
  },
  {
    ...
    category: "coding",
    excerpt: "Understanding layouts, loading states, and parallel routes at the architecture level.",
    image_src: "",
    date: "2026-04-15",
    featured: false,
    publish_status: "published",
...
function FeaturedBadge() {
  return (
    <span className="inline-flex items-center gap-1 px-2 py-[2px] text-[7px] tracking-[0.25em] font-mono uppercase border border-[#e8c830] text-[#e8c830] bg-transparent">
      ★ FEAT
    </span>
  );
}
...
const FILTER_TABS: FilterTab[] = ["ALL", "PUBLISHED", "DRAFT", "FEATURED"];
...
export default function AdminArticlesListPage() {
  ...
  const published = articles.filter((a) => a.publish_status === "published").length;
  const drafts    = articles.filter((a) => a.publish_status === "draft").length;
  ...
  const filtered = articles.filter((a) => {
    ...
    const matchFilter =
      activeFilter === "ALL" ||
      (activeFilter === "PUBLISHED" && a.publish_status === "published") ||
      (activeFilter === "DRAFT"     && a.publish_status === "draft") ||
      (activeFilter === "FEATURED"  && a.featured);
      ...
      <PageContainer>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#b8b8b8] border border-[#b8b8b8]">
            ...
            <StatCell label="FEATURED"  value={featured} />
          </div>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col border border-[#b8b8b8] bg-[#b8b8b8] gap-px overflow-hidden">
            ...
            <div className="hidden md:grid bg-[#1a1a1a] px-5 py-3 gap-4 items-center"
              style={{ gridTemplateColumns: "80px 1fr 90px 90px 70px 90px 120px" }}
            >
              {["ID", "TITLE", "CATEGORY", "STATUS", "FEAT", "DATE", "ACTIONS"].map((h) => (
  ...
  return (
    <div className="group relative bg-[#c9c9c9] hover:bg-[#1a1a1a] transition-colors duration-150">
      ...
      >
        ...
        <span className="text-[9px] tracking-[0.1em] text-[#aaa] group-hover:text-[#555] font-mono transition-colors">
          {article.date}
        </span>
      ...
      <div className="md:hidden px-5 py-4 flex flex-col gap-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex flex-col gap-1 flex-1 min-w-0">
            ...
            <span className="text-[8px] tracking-[0.1em] text-[#aaa] group-hover:text-[#555] font-mono transition-colors">
              {article.date}
            </span>
          </div>
