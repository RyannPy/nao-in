  ...
  return (
    <div className="flex flex-col gap-[6px]">
      <div className="flex items-center gap-3">
        <span className="text-[8px] tracking-[0.3em] text-[#aaa] uppercase font-mono">{code}</span>
        <span className="h-px flex-1 bg-[#333]" />
        <span className="text-[9px] tracking-[0.25em] text-[#888] uppercase font-mono">{label}</span>
      </div>
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111] flex items-center justify-center relative overflow-hidden font-mono">
      ...
      {/* ── Background texture ── */}
      <div aria-hidden className="pointer-events-none absolute inset-0 opacity-[0.06]" style={TEXTURE_STYLE} />

      {/* ── Scanlines ── */}
      <div aria-hidden className="pointer-events-none absolute inset-0" style={SCANLINE_STYLE} />
      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-[8px] tracking-[0.4em] text-[#555] uppercase">SYS-ACCESS</span>
            <span className="h-px flex-1 bg-[#222]" />
            <span className="text-[8px] tracking-[0.3em] text-[#444] uppercase">RESTRICTED</span>
          </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[8px] tracking-[0.2em] text-[#555] uppercase">SYSTEM ONLINE</span>
          </div>
